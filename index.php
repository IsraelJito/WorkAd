...
<div class="bgded overlay light" style="background-image:url('images/RemoteWork.jpg');"> 
  ...
  <div class="wrapper row0">
    <div id="topbar" class="hoc clear"> 
      ...
      <div class="fl_left"> 
        <!-- ################################################################################################ -->
        <ul class="nospace">
          <li><i class="fa fa-phone"></i> +234 811 282 3135</li>
  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      ...
      <div id="logo" class="fl_left">
        <h1><a href="index.php">Chief Paul</a></h1>
      </div>
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          <li class="active"><a href="index.php">Home</a></li>
          <li><a href="pages/gallery.php">Our Work</a></li>
  ...
  <div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
      <h3 class="heading">Web Design<br>
        ligula cras lobortis tortor</h3>
      <p>Developing Website, Softwares and Mobile Apps With The Latest and Best Technology Stack.</p>
      <footer><a class="btn" href="pages/contact.php">Contact Us</a></footer>
    </article>
    <!-- ################################################################################################ -->
  </div>
  <!-- ################################################################################################ -->
...
<!-- ################################################################################################ -->
<div class="wrapper row2 bgded overlay" style="background-image:url('images/ExplainWork.jpg');">
  <section class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <div class="sectiontitle">
      <h6 class="heading">Our Services</h6>
      <p>Budget Friendly, We have Pocket Friendly Solutions so you dont break the bank to get the service you need.</p>
    </div>
    ...
    <footer class="center"><a class="btn" href="pages/contact.php">Contact Us!</a></footer>
    <!-- ################################################################################################ -->
  </section>
</div>
<!-- ################################################################################################ -->
<div class="wrapper row3">
  <figure class="hoc container clear"> 
    ...
    <figcaption class="sectiontitle">
      <h6 class="heading">Responsive Websites</h6>
      <p>These Are Some Of Our Project</p>
    </figcaption>
    ...
    <footer class="center"><a class="btn" href="pages/gallery.php">View More..</a></footer>
    <!-- ################################################################################################ -->
  </figure>
</div>
<!-- ################################################################################################# -->
<div class="wrapper row2 bgded overlay" style="background-image:url('images/Contract.jpg');">
  <section class="hoc container clear testimonials"> 
    <!-- ################################################################################################ -->
    <div class="sectiontitle">
      <h6 class="heading">Reviews From Some Of Our Clients.</h6>
      <p>We are always work with to meet time on our Projects!.</p>
    </div>
    ...
    <footer class="center"><a class="btn" href="pages/about.php">About Us &raquo;</a></footer>
    <!-- ################################################################################################ -->
  </section>
</div>
<!-- ############################################################################################### -->
<div class="wrapper">
  <section class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <div class="sectiontitle">
      <h6 class="heading">Our Professionals</h6>
      <p>Some of our expert developers!</p>
    </div>
    <div class="group excerpt btmspace-80">
      <article class="one_third first"><a class="imgover btmspace-30" href="#"><img src="images/demo/320x240.png" alt=""></a>
        <ul class="nospace meta">
          <li style="font-size: large;"><i class="fa fa-user"></i> <a href="#">Admin</a></li>
          <li style="font-size: large;"><i class="fa fa-tag"></i> <a href="#">Chief Paul</a></li>
        </ul>
      </article>
      <article class="one_third"><a class="imgover btmspace-30" href="#"><img src="images/demo/320x240.png" alt=""></a>
        <ul class="nospace meta">
          <li style="font-size: large;"><i class="fa fa-user"></i> <a href="#">Admin</a></li>
          <li style="font-size: large;"><i class="fa fa-tag"></i> <a href="#">Israel</a></li>
        </ul>
      </article>
      <article class="one_third"><a class="imgover btmspace-30" href="#"><img src="images/demo/320x240.png" alt=""></a>
        <ul class="nospace meta">
          <li style="font-size: large;"><i class="fa fa-user"></i> <a href="#">Admin</a></li>
          <li style="font-size: large;"><i class="fa fa-tag"></i> <a href="#">Mr Chief Gbem Gbem</a></li>
        </ul>
      </article>
    </div>
    <footer class="center"><a class="btn" href="pages/contact.php">Contact Us &raquo;</a></footer>
    <!-- ################################################################################################ -->
  </section>
</div>
