...
<div class="wrapper row2 bgded overlay" style="background-image:url('images/demo/backgrounds/04.png');">
  <section class="hoc cta clear"> 
    ...
    <div class="sectiontitle">
      ...
      <p>Used our services, leave a review!</p>
    </div>
    <form method="post" action="#">
      <fieldset>
        <legend>Newsletter:</legend>
        <input class="btmspace-15" type="text" value="" placeholder="Enter Your Email Here&hellip;">
        <textarea name="comment" placeholder="Leave comments" style="background-color: transparent; border-color: rgba(255,255,255,.2); width: 100%; padding: 8px; border: 1px solid; margin-bottom: 15px;"></textarea>
